...
::: incremental
- Transparency in motivation for experiments
- Moving beyond static data
- Careful thinking about features of focus groups (e.g. turn-taking, moderation)
:::
...
::: incremental
- Can R package be turned into (Shiny) app?
- Can we simulate a real time focus group with a human moderator?
- Use existing focus group transcripts to ask "what if" questions?
- Many insights from focus groups are non-verbal (e.g. agreeing out of conformity)
:::